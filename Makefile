...
test: $(TEST_PMM_BIN) $(TEST_HEAP_BIN) $(TEST_OBJECT_TABLE_BIN) $(TEST_OBJECT_HEADER_BIN) $(TEST_WAL_BIN) $(TEST_OBJECT_STORE_BIN) $(TEST_WRITE_ORDERING_BIN) $(TEST_WASM_SHIM_BIN) $(TEST_WASM_MODULE_BIN) $(TEST_SYSCALL_ARGS_BIN) $(TEST_COMPONENT_STATE_BIN) $(TEST_COMPONENT_MAILBOX_BIN)
	$(TEST_PMM_BIN)
	$(TEST_HEAP_BIN)
